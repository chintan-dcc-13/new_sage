            ...
            <div class="flex flex-wrap items-center justify-center m-0 p-0 w-full relative lg:gap-6 mb-40 last:mb-0">
                ...
                <div class="lgscreen:hidden">
                    @if ($social_media_item)
                        <ul
                            class="social-media m-0 flex flex-wrap items-center justify-center lg:justify-end gap-5 lg:gap-10">
                            @foreach ($social_media_item as $content)
                                <li>
                                    <a href="{{ $content['social_media_link'] }}">
                                        <img src="{{ $content['social_media_image'] }}"
                                            class="max-w-full h-auto block lozad">
                                    </a>
                                </li>
                            @endforeach
                        </ul>
                ...
                <div class="w-full lg:flex-1">
                    <div class="subscribe">
                        ...
                        <div class="lgscreen:w-full lg:hidden my-40">
                            @if ($social_media_item)
                                <ul
                                    class="social-media m-0 flex flex-wrap items-center justify-center lg:justify-end gap-[62px] lg:gap-10">
                                    @foreach ($social_media_item as $content)
                                        <li>
                                            <a href="{{ $content['social_media_link'] }}" target="_blank"
                                                rel="noopener noreferrer">
                                                <img src="{{ $content['social_media_image'] }}" width="32"
                                                    height="32" class="max-w-full h-auto block lozad" alt="facebook"
                                                    data-loaded="true">
                                            </a>
                                        </li>
                                    @endforeach
                ...
                <div class="w-full lg:flex-[0_0_40%]">
                    <div class="flex flex-col w-full m-0 p-0 relative lg:items-start justify-center gap-10 lg:gap-8">
                        ...
                        <div class="footer-info">
                            <ul>
                                <li>
                                    <img src="http://localhost/sage_theme/wp-content/uploads/2024/03/telephone.37b30a.svg"
                                        height="16" class="max-w-full h-auto block lozad" alt="telephone">
                                    <a href="tel:{{ $phone_number }}">
                                        {{ $phone_number }}
                                    </a>
                                </li>
                                <li>
                                    <img src="http://localhost/sage_theme/wp-content/uploads/2024/03/mail.e0ddec.svg"
                                        height="16" class="max-w-full h-auto block lozad" alt="mail">
                                    <a href="mailto:{{ $email }}">
                                        {{ $email }}
                                    </a>
                                </li>
                        ...
                        <div class="w-full copyrights relative z-1">
                            <div
                                class="flex lgscreen:flex-col lg:flex-wrap w-full justify-center lg:justify-end items-center">
                                ...
                                <a href="https://techyscouts.com/" class="techyscouts-credit-link flex-[1_0_auto]"
                                    target="_blank" rel="noopener noreferrer">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-100 0 3700 552"
                                        ...
                                        <path id="techyscouts-logo-heart" fill="#455A64"
                                        ...
                                        <path id="techyscouts-logo-line-1" fill="#455A64"
                                            d="M803 372L1016 0l34 20-213 372-34-20z"></path>
                                        <path id="techyscouts-logo-line-2" fill="#455A64"
                                            d="M879 552l-33-20 213-372 33 20-213 372z"></path>
                                        <path id="techyscouts-logo-text"
                                            ...
                                            style="fill:none;stroke:#455A64;stroke-width:16;"></path>
                                    </svg>
                                </a>
                            </div>
                        </div>
