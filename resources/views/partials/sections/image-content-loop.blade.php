        ...
        <div class="container-fluid xl3:container">
            @foreach ($loop_content as $content)
                <div class="py-40 lg:py-80">
                    <div
                        class="zigzag-gap flex flex-wrap items-center justify-center w-full m-0 p-0 relative lgscreen:gap-10">
                        <div
                            class="w-full lg:flex-1 @if ($content['content_position'] == 'left') lg:order-2 order-2 @elseif($content['content_position'] == 'right') lg:order-1 order-2 @endif">
                            <div class="content">
                        ...
                        <div
                            class="w-full lg:w-6/12 xl:max-w-[626px] @if ($content['content_position'] == 'left') lg:order-1 @elseif($content['content_position'] == 'right') lg:order-2 @endif order-1">
